...
El análisis comparado de ambos textos nos permite introducir la lectura del borrador presentado por la CC. El análisis de correlaciones nos indica que la constitución Pinochet-Lagos carece de correlaciones con principios y se encuentra orientada a procesos y procedimientos manteniendo su _visión de mundo_ implícita, una suerte de _currículum oculto_, no declarado que opera fuertemente en los procesos de producción de leyes y normas. 

Por su parte la propuesta de borrador es mucho más normativa y transparente en sus principios y sentidos. Los conceptos emergentes presentan un diversas dimensiones del mismo principio, **no se trata de un abordaje acotado de dichos princpios**, mas bien un conjunto equilibrado de valores en torno a ello. Muestra de esto es la idea de _libertad_; en la constitución Pinochet-Lagos se encuentra restringida a _provisional_ y _personal_ con correlaciones de 0.35 en tanto en el borrador presentado por la CC, aparece adicionalmente la _libertad de opinión_, la _compensación_ y otros conceptos relativos a ella, que enriquecen su ascepción y la hacen más plural. Así, conceptos como _expropiación_, _minería_ y _economía_ no se encuentran correlacionados con ascepciones acotadas, es posible observar una relación con una serie de conceptos que limitan y restringen su ejecución (en el caso de la expropiación) y de conceptos que amplían las dimensiones de los conceptos como lo es _agregado_ y _encadenamiento_ en _minería_ y _circular_ y _diversificación_ en economía.

En general en las materias de desarrollo económico y estratégico es posible observar conceptos cuyas correlaciones con otros conceptos son equilibrados y parsimoniosos; en las materias asociadas al reconocimiento de identidades, por su parte, las correlaciones presentadas por el borrador son multidimensionales e integran valores predominantemente laicos y corte liberal.
